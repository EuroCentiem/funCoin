...
uint256 hashGenesisBlock("0xf78005d7255113f3d959ea8b1aea66ed4c33a11e72b52baaca1ad81a160f4518");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100000); // Funcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Funcoin: 1 days
static const int64 nTargetSpacing = 5 * 60; // Funcoin: 5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x816816d44481097f7ee1ff94ca0238595a3316b860d0586a10553d496fbfedd2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Ireland Votes to End Abortion Ban, in Rebuke to Catholic Conservatism 27/05/2018";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04bb8261c1c897286490fba139480ec7a769bee7d165102c6a5ef0d678099e2b4b810759ac01eb2ba23d52e414bcf03659e7f3b9d97ca5fa5e2cf46f35d90626cf") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1527434072;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 389678106;

        if (fTestNet)
        {
            block.nTime    = 1527434020;
            block.nNonce   = 387167147;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x52bc1e8a00c9a5b4be1c8f5a5063f46d7c15f049aed6ba339f3c5e1d56313875"));
        block.print();
