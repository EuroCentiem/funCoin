    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Funcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  FunCoind [options]                     " + "\n" +
                  "  FunCoind [options] <command> [params]  " + _("Send command to -server or FunCoind") + "\n" +
                  "  FunCoind [options] help                " + _("List commands") + "\n" +
                  "  FunCoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: FunCoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Funcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Funcoin is probably already running."), strDataDir.c_str()));
